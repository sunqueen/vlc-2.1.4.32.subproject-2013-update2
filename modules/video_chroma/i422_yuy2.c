 ...
 * $Id: 09166533d0b6c6b1974c55c0df7de4ff6b277bc3 $
 *
...
static void I422_YUY2( filter_t *p_filter, picture_t *p_source,
                                           picture_t *p_dest )
{
#if defined (MODULE_NAME_IS_i422_yuy2)			// sunqueen add
...
#else
#if defined(MODULE_NAME_IS_i422_yuy2_sse2)
	cover_I422_YUY2_sse2( p_filter, p_source, p_dest );
#else
	cover_I422_YUY2_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}
...
#else
#if defined(MODULE_NAME_IS_i422_yuy2_sse2)
	cover_I422_YVYU_sse2( p_filter, p_source, p_dest );
#else
	cover_I422_YVYU_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}
...
#else
#if defined(MODULE_NAME_IS_i422_yuy2_sse2)
	cover_I422_UYVY_sse2( p_filter, p_source, p_dest );
#else
	cover_I422_UYVY_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}
...
#else
#if defined(MODULE_NAME_IS_i422_yuy2_sse2)
	cover_I422_cyuv_sse2( p_filter, p_source, p_dest );
#else
	cover_I422_cyuv_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}

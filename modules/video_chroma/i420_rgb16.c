...
//#   include "../mmx/i420_rgb_mmx.h"	// sunqueen delete
#include "chroma_asm.h"					// sunqueen add
#   define VLC_TARGET VLC_MMX
#elif defined (MODULE_NAME_IS_i420_rgb_sse2)
//#   include "../sse2/i420_rgb_sse2.h"	// sunqueen delete
#include "chroma_asm.h"				// sunqueen add
...
//VLC_TARGET			// sunqueen delete
void I420_R5G5B5( filter_t *p_filter, picture_t *p_src, picture_t *p_dest )
{
// sunqueen add start
#if defined (MODULE_NAME_IS_i420_rgb_sse2)
	cover_I420_R5G5B5_sse2( p_filter, p_src, p_dest );
#else
	cover_I420_R5G5B5_mmx( p_filter, p_src, p_dest );
#endif
// sunqueen add end
...
// sunqueen add start
#if defined (MODULE_NAME_IS_i420_rgb_sse2)
	cover_I420_R5G6B5_sse2( p_filter, p_src, p_dest );
#else
	cover_I420_R5G6B5_mmx( p_filter, p_src, p_dest );
#endif
// sunqueen add end
...
// sunqueen add start
#if defined (MODULE_NAME_IS_i420_rgb_sse2)
	cover_I420_A8R8G8B8_sse2( p_filter, p_src, p_dest );
#else
	cover_I420_A8R8G8B8_mmx( p_filter, p_src, p_dest );
#endif
// sunqueen add end
...
// sunqueen add start
#if defined (MODULE_NAME_IS_i420_rgb_sse2)
	cover_I420_R8G8B8A8_sse2( p_filter, p_src, p_dest );
#else
	cover_I420_R8G8B8A8_mmx( p_filter, p_src, p_dest );
#endif
// sunqueen add end
...
// sunqueen add start
#if defined (MODULE_NAME_IS_i420_rgb_sse2)
	cover_I420_B8G8R8A8_sse2( p_filter, p_src, p_dest );
#else
	cover_I420_B8G8R8A8_mmx( p_filter, p_src, p_dest );
#endif
// sunqueen add end
...
// sunqueen add start
#if defined (MODULE_NAME_IS_i420_rgb_sse2)
	cover_I420_A8B8G8R8_sse2( p_filter, p_src, p_dest );
#else
	cover_I420_A8B8G8R8_mmx( p_filter, p_src, p_dest );
#endif
// sunqueen add end

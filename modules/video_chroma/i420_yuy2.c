...
// sunqueen add start
#if defined (MODULE_NAME_IS_i420_yuy2) || defined (MODULE_NAME_IS_i420_yuy2_altivec)
#include "i420_yuy2.h"
#elif defined (MODULE_NAME_IS_i420_yuy2_mmx) || defined (MODULE_NAME_IS_i420_yuy2_sse2)
...
static void I420_YUY2( filter_t *p_filter, picture_t *p_source,
                                           picture_t *p_dest )
{
#if defined (MODULE_NAME_IS_i420_yuy2) || defined (MODULE_NAME_IS_i420_yuy2_altivec)		// sunqueen add
...
#else
#if defined(MODULE_NAME_IS_i420_yuy2_sse2)
	cover_I420_YUY2_sse2( p_filter, p_source, p_dest );
#else
	cover_I420_YUY2_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}
...
#else
#if defined(MODULE_NAME_IS_i420_yuy2_sse2)
	cover_I420_YVYU_sse2( p_filter, p_source, p_dest );
#else
	cover_I420_YVYU_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}
...
#else
#if defined(MODULE_NAME_IS_i420_yuy2_sse2)
	cover_I420_UYVY_sse2( p_filter, p_source, p_dest );
#else
	cover_I420_UYVY_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}
...
#else
#if defined(MODULE_NAME_IS_i420_yuy2_sse2)
	cover_I420_cyuv_sse2( p_filter, p_source, p_dest );
#else
	cover_I420_cyuv_mmx( p_filter, p_source, p_dest );
#endif
#endif
// sunqueen add end
}

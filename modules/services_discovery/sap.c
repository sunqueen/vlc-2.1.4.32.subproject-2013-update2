...
//        struct pollfd ufd[n];
      	struct pollfd *ufd = (struct pollfd *)malloc(sizeof(struct pollfd) * (n));			// sunqueen modify
                                ...
                                sdp_t *p_sdp )
{
    ...
    TAB_APPEND( (sap_announce_t **), p_sys->i_announces, p_sys->pp_announces, p_sap );			// sunqueen modify
...
//        char line[linelen + 1];
        char *line = (char *)malloc(linelen + 1);			// sunqueen modify
        ...
        switch (expect)
        {
            ...
            case 'A':
                ...
                if (cat == 'a')
                {
                    ...
                    TAB_APPEND( (attribute_t **), p_sdp->i_attributes, p_sdp->pp_attributes, p_attr );			// sunqueen modify
                    break;
                }
            ...
            case 'a':
                ...
                if (cat == 'a')
                {
                    ...
                    TAB_APPEND ((attribute_t **), p_sdp->mediav[p_sdp->mediac - 1].i_attributes,			// sunqueen modify
                       ...
                       int i_port )
{
    ...
    INSERT_ELEM ((int *), p_sd->p_sys->pi_fd, p_sd->p_sys->i_fd,			// sunqueen modify
                           ...
                           sap_announce_t *p_announce )
{
    ...
    for( i = 0; i< p_sd->p_sys->i_announces; i++)
    {
        ...
        {
            REMOVE_ELEM( (sap_announce_t **), p_sd->p_sys->pp_announces, p_sd->p_sys->i_announces,			// sunqueen modify
                         i);
            break;
        }
    }

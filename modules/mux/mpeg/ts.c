 ...
 * $Id: d514f5cc075bd331528fdde2341c4c5b45975bd6 $
 *
...
//        uint8_t psz_sdt_desc[3 + provlen + servlen];
        uint8_t *psz_sdt_desc = (uint8_t *)malloc(sizeof(uint8_t) * (3 + provlen + servlen));			// sunqueen modify
...
#endif
		free(psz_sdt_desc);			// sunqueen add
    }

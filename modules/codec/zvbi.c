 ...
 * $Id: fdf326f15991ba133e8ea213f13543c876965557 $
 *
...
// sunqueen add start
extern void *_decode_pointer(void *ptr);
void *_decode_pointer(void *ptr)
{
	return DecodePointer(ptr);
}

extern void *_encode_pointer(void *ptr);
...
//        char p_text[i_textsize+1];
        char *p_text = (char *)malloc(i_textsize+1);
		// sunqueen modify end

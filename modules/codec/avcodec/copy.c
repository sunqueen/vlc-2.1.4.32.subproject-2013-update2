...
#include "copy.h"
#include "copy_asm.h"			// sunaueen add
 ...
 */
//VLC_SSE			// sunqueen delete
static void CopyFromUswc(uint8_t *dst, size_t dst_pitch,
                         const uint8_t *src, size_t src_pitch,
                         unsigned width, unsigned height,
                         unsigned cpu)
{
	cover_CopyFromUswc(dst, dst_pitch, src, src_pitch, width, height, cpu);			// sunqueen add
...
static void Copy2d(uint8_t *dst, size_t dst_pitch,
                   ...
                   unsigned width, unsigned height)
{
	cover_Copy2d(dst, dst_pitch, src, src_pitch, width, height);			// sunqueen add
// sunqueen delete start
#if 0
...
{
	cover_SSE_SplitUV(dstu, dstu_pitch, dstv, dstv_pitch, src, src_pitch, width, height, cpu);			// sunqueen add
// sunqueen delete start
#if 0
...
static void SSE_CopyPlane(uint8_t *dst, size_t dst_pitch,
                          ...
                          unsigned width, unsigned height, unsigned cpu)
{
	cover_SSE_CopyPlane(dst, dst_pitch, src, src_pitch, cache, cache_size, width, height, cpu);			// sunqueen add
// sunqueen delete start
#if 0
...
static void SSE_SplitPlanes(uint8_t *dstu, size_t dstu_pitch,
                            ...
                            unsigned width, unsigned height, unsigned cpu)
{
	cover_SSE_SplitPlanes(dstu, dstu_pitch, dstv, dstv_pitch, src, src_pitch, cache, cache_size, width, height, cpu);			// sunqueen add
// sunqueen delete start
#if 0
...
{
	cover_SSE_CopyFromNv12(dst, src, src_pitch, width, height, cache, cpu);			// sunqueen add
// sunqueen delete start
#if 0
...
static void SSE_CopyFromYv12(picture_t *dst,
                             ...
                             copy_cache_t *cache, unsigned cpu)
{
	cover_SSE_CopyFromYv12(dst, src, src_pitch, width, height, cache, cpu);			// sunqueen add
// sunqueen delete start
#if 0
                  ...
                  copy_cache_t *cache)
{
    ...
    if (vlc_CPU_SSE2())
        return cover_SSE_CopyFromNv12(dst, src, src_pitch, width, height,
                                cache, cpu);			// sunqueen modify
#else
    (void) cache;
#endif
                  ...
                  copy_cache_t *cache)
{
    ...
    unsigned cpu = vlc_CPU();
    if (vlc_CPU_SSE2())
        return cover_SSE_CopyFromYv12(dst, src, src_pitch, width, height,
                                cache, cpu);			// sunqueen modify
#else
    (void) cache;
#endif

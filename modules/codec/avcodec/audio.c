...
//        const void *planes[ctx->channels];
        const void **planes = (const void **)malloc(ctx->channels * sizeof(void *));			// sunqueen modify
...
static void SetupOutputFormat( decoder_t *p_dec, bool b_trust )
{
	...
	uint32_t *pi_order_src = malloc(i_order_max * sizeof(uint32_t));			// sunqueen modify
	...
	free(pi_order_src);			// sunqueen add
}

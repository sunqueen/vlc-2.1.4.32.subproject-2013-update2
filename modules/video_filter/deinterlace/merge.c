...
#include "deinterlance_asm.h"				// sunqueen add
...
void MergeMMXEXT( void *_p_dest, const void *_p_s1, const void *_p_s2,
                  size_t i_bytes )
{
	cover_MergeMMXEXT(_p_dest, _p_s1, _p_s2, i_bytes);			// sunqueen add
...
void Merge3DNow( void *_p_dest, const void *_p_s1, const void *_p_s2,
                 size_t i_bytes )
{
	cover_Merge3DNow(_p_dest, _p_s1, _p_s2, i_bytes);			// sunqueen add
...
void Merge8BitSSE2( void *_p_dest, const void *_p_s1, const void *_p_s2,
                    size_t i_bytes )
{
	cover_Merge8BitSSE2(_p_dest, _p_s1, _p_s2, i_bytes);			// sunqueen add
...
void Merge16BitSSE2( void *_p_dest, const void *_p_s1, const void *_p_s2,
                     size_t i_bytes )
{
	cover_Merge16BitSSE2(_p_dest, _p_s1, _p_s2, i_bytes);			// sunqueen add

...
#include "sepia_asm.h"			// sunqueen add
...
{
	cover_Sepia8ySSE2(dst, src, i_intensity_spread);			// sunqueen add
                            ...
                            void *p_data )
{
    ...
    atomic_store( &p_sys->i_intensity, (atomic_int)newval.i_int );			// sunqueen modify
    return VLC_SUCCESS;
}

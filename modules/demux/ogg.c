        ...
        case DEMUX_GET_TITLE_INFO:
        {
            ...
            if( p_sys->i_seekpoints > 0 )
            {
                ...
                *ppp_title = malloc( sizeof( input_title_t* ) );
                ...
                {
                    TAB_APPEND( (seekpoint_t **), p_title->i_seekpoint, p_title->seekpoint, p_sys->pp_seekpoints[i] );			// sunqueen modify
                }
                *pi_title_offset = 0;
                              ...
                              ogg_packet *p_oggpacket )
{
    ...
    if( p_stream->b_force_backup )
    {
        ...
        if( !b_xiph )
        {
            ...
            {
//#warning Memory leak			// sunqueen delete
    ...
    while( Ogg_ReadPage( p_demux, &p_ogg->current_page ) == VLC_SUCCESS )
    {
        ...
        if( ogg_page_bos( &p_ogg->current_page ) )
        {
            ...
            while( ogg_page_bos( &p_ogg->current_page ) )
            {
                ...
                TAB_APPEND( (logical_stream_t **), p_ogg->i_streams, p_ogg->pp_stream, p_stream );			// sunqueen modify

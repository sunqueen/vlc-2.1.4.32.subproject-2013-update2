...
#define CONFIGURE_LINE "./configure  '--host=i686-pc-mingw32' '--enable-lua' '--enable-faad' '--enable-flac' '--enable-theora' '--enable-twolame' '--enable-quicktime' '--enable-avcodec' '--enable-merge-ffmpeg' '--enable-dca' '--enable-mpc' '--enable-libass' '--enable-x264' '--enable-schroedinger' '--enable-realrtsp' '--enable-live555' '--enable-dvdread' '--enable-shout' '--enable-goom' '--enable-caca' '--disable-sdl' '--enable-qt' '--enable-qt4' '--enable-skins2' '--enable-sse' '--enable-mmx' '--enable-libcddb' '--enable-zvbi' '--disable-telx' '--enable-nls' '--disable-dirac' '--disable-taglib' '--disable-mkv' '--disable-sftp' 'host_alias=i686-pc-mingw32' 'CC=i686-w64-mingw32-gcc' 'LDFLAGS=-L/usr/win32/lib' 'CPPFLAGS=-I/usr/win32/include -I/usr/win32/include/ebml' 'CXX=i686-w64-mingw32-g++' 'PKG_CONFIG_LIBDIR=/usr/win32/lib/pkgconfig'"

/* Copyright string */
#define COPYRIGHT_MESSAGE "Copyright © 1996-2014 the VideoLAN team"
...
//#define HAVE_ASPRINTF 1			// sunqueen delete
...
#define HAVE_STATIC_ASSERT 1			// sunqueen modify
//# define static_assert			// sunqueen add
...
/* Define to 1 if you have asprintf function */
//#define HAVE_VASPRINTF 1			// sunqueen delete
...
#define VERSION_MESSAGE "2.1.4 Rincewind"
...
/* Define to the equivalent of the C99 'restrict' keyword, or to
   ...
   supported directly.  */
#define restrict 		//__restrict			// sunqueen modify

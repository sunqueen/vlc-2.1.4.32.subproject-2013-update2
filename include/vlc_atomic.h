...
# else
//#  error FIXME: implement atomic operations for this compiler.			// sunqueen delete

// sunqueen add start
#ifdef __cplusplus

template < class T > void atomic_store( T *object, T desired )
{
    do {
		T *_obj = (object);
		T _des = (desired);
...
template < class T > T atomic_load( T *object )
{
	T *_obj = (object);
	T _old;
    vlc_global_lock(VLC_ATOMIC_MUTEX);
...
template < class T > T atomic_exchange( T *object, T desired )
{
    T *_obj = (object);
    T _des = (desired);
    T _old;
...
template < class T > bool atomic_compare_exchange_strong( T *object, T *expected, T desired )
{ \
    T *_obj = (object);
    T *_exp = (expected);
    T _des = (desired);
...
template < class T > T atomic_fetch_add( T *object, T desired )
{
    T *_obj = (object);
    T _des = (desired);
    T _old;
...
template < class T > T atomic_fetch_sub( T *object, T desired )
{
    T *_obj = (object);
    T _des = (desired);
    T _old;
...
template < class T > T atomic_fetch_or( T *object, T desired )
{
    T *_obj = (object);
    T _des = (desired);
    T _old;
...
template < class T > T atomic_fetch_xor( T *object, T desired )
{
    T *_obj = (object);
    T _des = (desired);
    T _old;
...
template < class T > T atomic_fetch_and( T *object, T desired )
{
    T *_obj = (object);
    T _des = (desired);
    T _old;

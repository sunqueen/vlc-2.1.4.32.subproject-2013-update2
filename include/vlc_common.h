...
#define __attribute__(x)			// sunqueen add
#if defined(_WIN32)
...
// sunqueen delete end
//#elif defined(__APPLE__) && !defined(MAC_OS_X_VERSION_10_6)			// sunqueen modify
#if defined(__APPLE__) && !defined(MAC_OS_X_VERSION_10_6) || defined(_WIN32)

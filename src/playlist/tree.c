                         ...
                         bool b_delete_items, bool b_force )
{
    ...
    if( i != -1 )
        ARRAY_REMOVE( (playlist_item_t **), p_playlist->all_items, i );			// sunqueen modify
    ...
    if( i != -1 )
        ARRAY_REMOVE( (playlist_item_t **), p_playlist->current, i );			// sunqueen modify
                         ...
                         int i_position )
{
    ...
    INSERT_ELEM( (playlist_item_t **),			// sunqueen modify
                        ...
                        playlist_item_t *p_parent )
{
    ...
    for(int i= 0; i< p_parent->i_children ; i++ )
    {
        ...
        {
            REMOVE_ELEM( (playlist_item_t **), p_parent->pp_children, p_parent->i_children, i );			// sunqueen modify
            ret = VLC_SUCCESS;
        }
    }

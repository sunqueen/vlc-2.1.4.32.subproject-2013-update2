...
{
    aout_volume_t *vol = (aout_volume_t *)vlc_custom_create(parent, sizeof (aout_volume_t),			// sunqueen modify
                                           "volume");
                                   ...
                                   const audio_replay_gain_t *replay_gain)
{
    ...
    else
    {
        ...
        if (var_InheritBool (obj, "audio-replay-gain-peak-protection"))
            multiplier = cover_fminf (multiplier, replay_gain->pb_peak[mode]			// sunqueen modify
...
{
    aout_volume_t *vol = (aout_volume_t *)data;			// sunqueen modify

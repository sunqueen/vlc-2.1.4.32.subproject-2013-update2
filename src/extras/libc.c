...
# else
    return cover_iconv_open( tocode, fromcode );			// sunqueen modify
# endif
#else
...
//                  outbuf, outbytesleft );
    return cover_iconv( cd, (const char **)inbuf, inbytesleft,
                  outbuf, outbytesleft );			// sunqueen modify
#else
    abort ();
#endif
}
...
//    return iconv_close( cd );
    return cover_iconv_close( cd );			// sunqueen modify
#else
    abort ();
#endif
}

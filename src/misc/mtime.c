...
#else
# include <time.h>			// sunqueen modify
#endif
...
uint64_t NTPtime64 (void)
{
	...
	memcpy((char *)&largeTime, (char *)&fileTime, sizeof(LARGE_INTEGER));

	ts.tv_sec  = (uint32_t)(largeTime.QuadPart/10000000L);
	ts.tv_nsec = (uint32_t)(systemTime.wMilliseconds / 1000);
	// sunqueen add end
#endif

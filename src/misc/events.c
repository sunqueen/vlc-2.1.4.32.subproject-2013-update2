        ...
        vlc_event_type_t event_type )
{
    ...
    ARRAY_APPEND( (vlc_event_listeners_group_t **), p_em->listeners_groups, listeners_group );			// sunqueen modify
                      ...
                      void *p_user_data )
{
    ...
    FOREACH_ARRAY( listeners_group, p_em->listeners_groups )
        ...
        {
            ARRAY_APPEND( (vlc_event_listener_t **), listeners_group->listeners, listener );			// sunqueen modify
            vlc_mutex_unlock( &p_em->object_lock );
            return VLC_SUCCESS;
        }
    FOREACH_END()
        ...
        if( listeners_group->event_type == event_type )
        {
            FOREACH_ARRAY( listener, listeners_group->listeners )
                    ...
                    listener->p_user_data == p_user_data )
                {
                    ...
                    /* that's our listener */
                    ARRAY_REMOVE( (vlc_event_listener_t **), listeners_group->listeners,			// sunqueen modify
